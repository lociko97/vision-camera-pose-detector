...
public class PoseRecognitionFrameProcessor extends FrameProcessorPlugin {
      ...
      try {
        Pose pose = Tasks.await(task);
          ...
          for(PoseLandmark landmark: landmarks) {
            ...
            result.putDouble("inFrameLikelihood", landmark.getInFrameLikelihood());
